...
BUILD_APP=$(NES_EMU)/abstract_file.o $(NES_EMU)/apu_state.o $(NES_EMU)/Blip_Buffer.o $(NES_EMU)/Effects_Buffer.o \
	...
	$(NES_EMU)/Nes_Buffer.o $(NES_EMU)/Nes_Cart.o $(NES_EMU)/Nes_Core.o $(NES_EMU)/Nes_Cpu.o $(NES_EMU)/Nes_File.o \
	$(NES_EMU)/nes_data.o $(NES_EMU)/Nes_Effects_Buffer.o $(NES_EMU)/Nes_Emu.o $(NES_EMU)/Nes_State.o \
